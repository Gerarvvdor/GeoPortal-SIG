        ...
        <div className="max-w-md w-full text-center">
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            ...
            <p className="text-gray-600 mb-4">
              Tu cuenta ha sido creada exitosamente. El perfil se está configurando en la base de datos.
            </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Únete al Geoportal Médico de El Salvador</p>
        </div>
        ...
        <div className="mt-6 bg-gray-50 rounded-lg p-4 border border-gray-200">
          ...
          <div className="text-xs text-gray-600 space-y-1">
            <p>🔗 Conexión directa con Supabase</p>
            <p>👤 Los perfiles se crean automáticamente</p>
            <p>🔐 Rol por defecto: 'user'</p>
          </div>
        </div>
      </div>
    </div>
